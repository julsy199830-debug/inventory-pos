  ...
  return (
    <>
      ...
      <button
        ...
        className="inline-flex items-center justify-center rounded-md p-1.5 text-zinc-400 transition-colors hover:bg-zinc-100 hover:text-zinc-700"
      >
        <svg
          className="h-4 w-4"
          ...
          <div className="w-full max-w-lg overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-xl">
            ...
            <form onSubmit={onSubmit} ref={formRef} className="space-y-4 px-5 py-5">
              ...
              <div className="grid grid-cols-3 gap-4">
                <Field label="Retail price (USD)" htmlFor="price" required>
                  <input
                    id="price"
                    name="price"
                    type="number"
                ...
                <Field label="Cost price (USD)" htmlFor="cost" required>
                  <input
                    id="cost"
                    name="cost"
                    type="number"
