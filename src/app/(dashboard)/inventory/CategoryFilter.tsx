...
export default function CategoryFilter({
  ...
  return (
    <select
      ...
      className="rounded-xl border border-slate-200/80 bg-white shadow-sm px-3.5 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 focus:border-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-600/10 disabled:opacity-60"
    >
